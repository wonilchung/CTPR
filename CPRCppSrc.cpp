...
* Description: C++ Functions for Cross-Trait Penalized Regression Model
******************************************************************************/
...
std::string date = "12/13/2016";
std::string year = "2016";

void PrintVersion(){
	std::cout << "-------------------------------------------------------------" << std::endl;
	std::cout << "          CTPR (CROSS-TRAIT PENALIZED REGRESSION)            " << std::endl;
	std::cout << "-------------------------------------------------------------" << std::endl;
	std::cout << std::endl;
	std::cout << "Version " << version << ", " << date << "                   " << std::endl;
	std::cout << "Visit https://www.hsph.harvard.edu/wonil-chung for Updates  " << std::endl;
	std::cout << "(C) " << year << " Wonil Chung                              " << std::endl;
...
void PrintLicense(){
	std::cout << "-------------------------------------------------------------" << std::endl;
	std::cout << "                       CTPR LICENSE                          " << std::endl;
	std::cout << "-------------------------------------------------------------" << std::endl;
	std::cout << std::endl;
...
void PrintHelp(int option){
	std::cout << "-------------------------------------------------------------" << std::endl;
	std::cout << "                        CTPR HELP                            " << std::endl;
	std::cout << "-------------------------------------------------------------" << std::endl;
	std::cout << std::endl;
	if (option==0) {
		std::cout << "CTPR version " << version << ", released on "<< date << std::endl;
		std::cout << "Implemented by Wonil Chung" << std::endl;
		std::cout << std::endl;
		std::cout << "Type ./ctpr or ./ctprmpi -h [num] for more detailed helps"<< std::endl;
		std::cout << "Options: " << std::endl;
		std::cout << "1: Quick guide" << std::endl;
		std::cout << "2: File I/O related" << std::endl;
		std::cout << std::endl;
	} else {
		std::cout << "Working on help files..." << std::endl;
		std::cout << std::endl;
	}
}
...
void ComputeCVRes(arma::fvec & b_min, arma::fvec & b_min0, arma::field<arma::fmat> & mse, arma::field<arma::fmat> & b_est,	
	arma::field<arma::fvec> & lambda1, arma::fvec & lambda2, int nFold, arma::umat & nzero, arma::fvec & cprRes, arma::fmat & cvm){
	...
	cprRes(3) = lambda1(ind0)(min_ind_r0); cprRes(4) = nzero(min_ind_r0, ind0); cprRes(5) = cvm_min0;
	cprRes(9) = lambda1(min_ind_c)(min_ind_r); cprRes(10) = lambda2(min_ind_c); cprRes(11) = nzero(min_ind_r, min_ind_c); 
	cprRes(12) = cvm_min;
